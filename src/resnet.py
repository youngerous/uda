...
ref: https://github.com/lepoeme20/pytorch-image-classification
"""
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=10, input_channels=3):
        super().__init__()
    ...
    def forward(self, x):
        ...
        feature_map = self.conv5_x(output)
        output = self.avg_pool(feature_map)
